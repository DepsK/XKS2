 ...
 * @date 2018/3/13.
 */
public class HWHttpUtils {

    public interface OnLoadCompletedListener{
        void OnLoadCompleted(String json);
    }

    private static ThirdHttpUtils.OnLoadCompletedListener mListener;
    public static void loadJson(final Activity activity, ThirdHttpUtils.OnLoadCompletedListener listener){
        mListener = listener;
        //1.创建一个客户对象
